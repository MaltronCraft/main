...
$formproc_obj->initTimeZone('US/Arizona');
...
$formproc_obj->AddElementInfo('MCVersions','listbox','');
$formproc_obj->AddElementInfo('UsernameBedrock','text','');
$formproc_obj->AddElementInfo('UsernameJava','text','');
...
$validator->addValidation("LastName","required","Please enter in your Last name.");
$validator->addValidation("Email","email","Please enter a valid email to reply back to you.");
$validator->addValidation("MCVersions","dontselect=What editions do you play on?","Please select an option for MCVersions");
$validator->addValidation("UsernameBedrock","required","Please enter your MCPE/Win 10 username. If you dont have one type \"none\"","is_selected_list_item(MCVersions,\"MCPE/Win 10 (Bedrock)\") && is_selected_list_item(MCVersions,\"Both\")");
$validator->addValidation("UsernameJava","required","Please enter your MC Java username. If you dont have one type \"none\"","is_selected_list_item(MCVersions,\"MC Java\") && is_selected_list_item(MCVersions,\"Both\")");
...
$autoresp->SetToVariables('','Email');
$formproc_obj->addModule($autoresp);

$csv_maker =  new FM_FormDataCSVMaker(1024);
$csv_maker->AddCSVVariable(array('_sfm_form_submision_time_','_sfm_form_submision_date_','_sfm_referer_page_','_sfm_visitor_ip_','_sfm_visitor_browser_','_sfm_visitor_os_','_sfm_user_agent_','_sfm_unique_id_','Email','Message','FirstName','LastName','MCVersions','UsernameBedrock','UsernameJava'));
