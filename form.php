...
<li class='field_block' id='field_2_div'><div class='col_label'>
	...
	<div id='field_2_tip' class='instruction'>For Replys</div>
	</div>
</li>

<li class='field_block' id='field_3_div'><div class='col_label'>
	<label class='form_field'>Username for Bedrock</label> <label class='form_required' >&nbsp;</label> </div>
	<div class='col_field'>
	<input type="text" name="field_3"  id="field_3" value="<?php  phpfmg_hsc("field_3", ""); ?>" class='text_box'>
	<div id='field_3_tip' class='instruction'>MCPE/Win 10 Username</div>
	</div>
</li>

<li class='field_block' id='field_4_div'><div class='col_label'>
	<label class='form_field'>Username for Java</label> <label class='form_required' >&nbsp;</label> </div>
	<div class='col_field'>
	<input type="text" name="field_4"  id="field_4" value="<?php  phpfmg_hsc("field_4", ""); ?>" class='text_box'>
	<div id='field_4_tip' class='instruction'>Java Username</div>
	</div>
</li>
...
<li class='field_block' id='field_5_div'><div class='col_label'>
	...
	<div id='field_5_tip' class='instruction'>Enter your message here</div>
	</div>
</li>
